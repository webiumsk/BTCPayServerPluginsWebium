...
/// </summary>
internal static class FlashHttp
{
    /// <summary>Named HttpClient wired to <see cref="CreateSafeHandler"/> in <see cref="FlashPlugin"/>.</summary>
    public const string ClientName = "FlashSafeHttp";
