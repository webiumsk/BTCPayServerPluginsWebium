#!/bin/bash
# Build and pack Satflux Tickets plugin as an installable BTCPay Server plugin (.btcpay)

set -e

PROJECT_NAME="BTCPayServer.Plugins.SatfluxTickets"
PLUGIN_NAME="BTCPayServer.Plugins.SatfluxTickets"
