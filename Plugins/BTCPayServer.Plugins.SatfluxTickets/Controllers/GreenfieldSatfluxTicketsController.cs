...
[Route("~/api/v1/stores/{storeId}/satflux-tickets/events/{eventId}/")]
[Route("~/api/v1/stores/{storeId}/satoshi-tickets/events/{eventId}/")] // legacy alias - existing satflux/WordPress integrations
[ApiController]
[Authorize(AuthenticationSchemes = AuthenticationSchemes.Greenfield, Policy = Policies.CanModifyStoreSettings)]
[EnableCors(CorsPolicies.All)]
public class GreenfieldSatfluxTicketsController(
    ...
    ILogger<GreenfieldSatfluxTicketsController> logger) : ControllerBase
{
