...
/// </summary>
internal static class BlitzHttp
{
    /// <summary>Named HttpClient wired to <see cref="CreateSafeHandler"/> in <see cref="BlitzPlugin"/>.</summary>
    public const string ClientName = "BlitzSafeHttp";
