...
/// </summary>
public sealed class BlitzPersistence
{
    public const string SettingName = "Blitz.TrackedInvoices";
    private readonly ISettingsRepository _settings;

    public BlitzPersistence(ISettingsRepository settings) => _settings = settings;
